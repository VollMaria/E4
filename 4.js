...
// Приборы с собственными свойствами и методами
function Microwave(name, power, capacity) {
  this.name = name;
  this.power = power;
  this.capacity = capacity;
}

Microwave.prototype = new electroDevice();

Microwave.prototype.setTimer = function(timer) {
  console.log(`${this.name}: установлен таймер на ${timer} минут`);
};

function Multicooker(name, power, programs) {
  this.name = name;
  this.power = power;
  this.programs = programs;
}

Multicooker.prototype = new electroDevice();

Multicooker.prototype.cook = function(program) {
